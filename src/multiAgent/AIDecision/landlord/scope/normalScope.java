 ...
 */
public class normalScope extends scopeFactor {
    ...
    public Reduction scopeJudge(Order order, Reduction reduction) {
        ...
        if(days >= 3 && current_price*1.0 / init_price > 0.9){
            reduction.setMaxReduction(reduction.getMaxReduction()*1.15);
            reduction.setMinReduction(reduction.getMinReduction()*1.2);
        ...
        }else if(current_price*1.0 / init_price < 0.6){
